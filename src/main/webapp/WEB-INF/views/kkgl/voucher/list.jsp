...
<div class="layui-form-item">
    <div class="layui-inline" style="width: 100%;background-color: #f2f2f2;border-radius: 3px;height: 120px">
        <div style="width: 85%;float: left;display: inline-block">
            ...
            <div>
                <div class="layui-inline s_inpt">
                    <label class="layui-form-label "  style="line-height:12px;">卡号</label>
                    <div class="layui-input-inline tb_input ">
                        <input type="text" name="voucherid" id="faceCardNum" autocomplete="off" placeholder="请输入16位通衢卡卡号" class="layui-input tb_input">
                    </div>
                </div>
                <div class="layui-inline s_inpt">
                    <label class="layui-form-label "  style="line-height:12px;">车牌号码</label>
                    <div class="layui-input-inline tb_input ">
                        <input type="text" name="vehiclePlate" id="vehiclePlate"  autocomplete="off" class="layui-input tb_input">
                    </div>
                </div>
                <div class="layui-inline s_inpt">
                    <label class="layui-form-label "  style="line-height:12px;">车牌颜色</label>
                    <div class="layui-input-inline tb_input ">
                        <select name="vehicleColor" class="tb_input" name="vehicleColor"  id="vehicleColor" style="height: 30px;border-radius: 3px;border-color: #e5e5e5;">
                            <option value="">全部</option>
                            <option value="0">蓝色</option>
                            <option value="1">黄色</option>
                            <option value="2">黑色</option>
                            <option value="3">白色</option>
                            <option value="4">渐变绿</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div style="width: 15%;margin-top: 28px;display: inline-block;">
                    ...
                    if(vehiclePlate!=""){
                        ...
                        if(vehiclePlate.length!=7){
                            ...
                            if(vehiclePlate.length!=8){
                                ...
                                var reg = /^([\u4e00-\u9fa5][a-zA-Z](([DF](?![IO])[A-Z0-9][0-9]{4})|([0-9]{5}[DF])))$/;
                                if(!reg.test(vehiclePlate)){
                                    layer.alert("输入的车牌号有误，请检查后重试！");
                                    return false;
                                }else{
                                    return true;
                                }
        ...
        layui.use('table', function() {
            ...
            table.on('tool(tb_filter)', function(obj){
                ...
                if(layEvent === 'detail'){
                    ...
                    location.href = '${ctx}/voucher/info/' + id;
