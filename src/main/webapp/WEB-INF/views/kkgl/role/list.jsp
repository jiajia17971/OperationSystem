    ...
    <div class="layui-inline" style="width: 100%;background-color: #f2f2f2;border-radius: 3px;">
        <div class="layui-inline" style="margin-top: 5px">
            ...
            <div class="layui-input-inline " style="margin-top: 5px">
                <input type="text" name="name" autocomplete="off" class="layui-input search_input" id="searchlgname" style="height: 30px">
            </div>
        </div>
        ...
        <button class="layui-btn" id="tbn_add" style="float: right;position:  relative;right: 92px;margin-top:  3px;">添加</button>
        <button class="layui-btn" data-type="reload" id="layui-btn1" style="position:  relative;float:  right;right: 112px;margin-top: 3px;">查询</button>
...
<script>
    layui.use('table', function() {
        ...
        if(layEvent === 'detail'){
        //发送请求
            location.href = '${ctx}/role/edit/' + id;
