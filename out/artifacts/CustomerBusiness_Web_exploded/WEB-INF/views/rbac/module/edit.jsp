      ...
      <div class="widget-content" id="formDiv">
        <div class="row">
          <div class="col-xs-4 form-inline" style="padding-top: 5px">
            <button id="addTopBtn" type="button" class="btn btn-danger">添加顶层模块</button>
            <button id="addChildBtn" type="button" class="btn btn-info">添加子层模块</button>
  ...
  <form>
    ...
    <div class="widget-bottom">
      ...
      <@
        if(scene == 1 || scene == 2) {
      @>
        <a class="btn btn-primary pull-right" id="addBtn">添加</a>
      <@
        } else {
      @>
        <a class="btn btn-danger pull-right" id="deleteBtn">删除</a>
        <a class="btn btn-success pull-right" id="updateBtn">修改</a>
      <@
        }
      @>
    </div>
