                ...
                <div class="layui-form-item" style="">
                    ...
                    <div class="layui-input-block" style="width: 32%;display: inline-block;float: left;margin-left: 0px">
                        <select name="type" lay-filter="" id="type" lay-verify="type" value="${voucher.type}" <c:if test="${'view' eq type}">disabled</c:if> >
                            ...
                            <option value="4" <c:if test="${'4' eq voucher.type}">selected</c:if>>跨行30天办理</option>
                            <option value="5" <c:if test="${'5' eq voucher.type}">selected</c:if>>收费异常</option>
                            <option value="6" <c:if test="${'6' eq voucher.type}">selected</c:if>>其他</option>
                        </select>
                    </div>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-upload">
                        ...
                        <div class="layui-upload-list" style="padding-left: 110px;">
                            <table class="layui-hide" id="cardlist"  lay-filter="tb_filter">
                ...
                <div class="layui-form-item layui-layout-admin">
                    <div class="layui-input-block">
                        <div class="layui-footer" style="left: 0;">
                            ...
                            <c:if test="${'3' eq voucher.status}">
                                <button  id="layui-pass"  class="layui-btn" style="margin-left: 40%">通过</button>


                                <button  id="layui-return"  class="layui-btn ">驳回</button>
                            </c:if>

                            <a  id="btn_back"  class="layui-btn " <c:if test="${'3' ne voucher.status}">style="margin-left: 40%"</c:if>>返回</a>
...
<script>
    ...
    $("#btn_back").click(function(){
        window.location.href = "${ctx}/voucher/checklist"
    })
    ...
    if($("#type").val()==3){
        conURL = '${ctx}/api/v1/reload/query';
        arrs = [ //标题栏
            {type:'numbers',
                title: '序号',
                templet: '#indexTpl',
    ...
    function previewImg(e) {
      var  url =  $(e.currentTarget).attr("id");
        ...
        src = url;
        var imgHtml = "<img src='${ctx}" + src + "' width='100%' height='90%'/><div width='100%' height='5%'><input type='button' class = 'layui-btn ' style='margin-left:20%' value='左旋转'><input type='button' class = 'layui-btn'  value='放大'><input type='button' class = 'layui-btn ' value='缩小'><input type='button' class = 'layui-btn ' value='右旋转'></div>";
